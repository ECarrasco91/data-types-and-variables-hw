...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        boolean varI = true;
        boolean varJ = (2 == 3);
        Interger varK = Integer.valueOf("9235");
        ...
        // The result of the division operation will be 3 because division of intergers does not
        // include whole number with decimals
    }
}
